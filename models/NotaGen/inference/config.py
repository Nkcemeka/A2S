...
INFERENCE_WEIGHTS_PATH = '/home/nkcemeka/Documents/trans_peft/tpeft/sym_utils/notagen/utilities/ckpts/weights-small.pth'               # Path to weights for inference# Folder to save output files
NUM_SAMPLES = 10000                                               # Number of samples to generate (only for generate mode)
