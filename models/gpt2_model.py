...
class GPT2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Here, we yield the hidden states and the layer index
        yield_array = [Tags.HIDDEN_STATES, hidden_states, encoder_hidden_states, self.layer_idx]
        yield yield_array
        hidden_states = yield_array[1]
        encoder_hidden_states = yield_array[2]
...
class GPT2Block(GradientCheckpointingLayer):
    ...
    def forward(
        ...
        **kwargs,
        ...
        attn_output, self_attn_weights = yield from self.attn(
            hidden_states,
        ...
        if encoder_hidden_states is not None:
            ...
            cross_attn_output, cross_attn_weights = yield from self.crossattention(
                hidden_states,
                past_key_values=past_key_values,
                attention_mask=attention_mask,
                head_mask=head_mask,
        ...
        residual = hidden_states
        yield_array = [Tags.PRENORM_OUTPUT, hidden_states, self.attn.layer_idx]
        yield yield_array
        hidden_states = yield_array[1]
